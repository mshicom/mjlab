...
from mjlab.asset_zoo.robots.nubot_z1.z1_constants import Z1_ACTION_SCALE, Z1_ROBOT_CFG
...
class Z1FlatEnvCfg(TrackingEnvCfg):
  def __post_init__(self):
    ...
    z1_cfg = replace(Z1_ROBOT_CFG, sensors=(self_collision_sensor,))
...
@dataclass
class Z1FlatEnvCfg_PLAY(Z1FlatEnvCfg):
  def __post_init__(self):
    super().__post_init__()
